...
const RecommendedArticleDetails = ({ articles, isLoading }) => {
  ...
  return (
    <div className="bg-[#FAFAFA] py-24 lg:px-12 px-4 mt-24">
      ...
      <div dir="rtl" className="lg:w-[97%] w-[100%] mx-auto mt-8">
        {articles?.result?.map((article: any, index: any) => (
          <div
            key={article.id}
            onClick={() => {
          ...
          >
            ...
            <div
              dir="rtl"
              className="flex lg:hidden lg:flex-row flex-col justify-between lg:items-center flex-wrap w-[100%] mt-2"
            >
              <div className="flex flex-row flex-wrap ">
                {article.tags.map((item: any) => (
                  <div
                    className="bg-[#F2F2F2] rounded-full py-2 px-6 ml-4 mt-3"
                    key={item.id}
                  >
                    <p className="text-[#404040] font-notoKufi-400 text-[0.625rem]">
                      {item.name}
...
export default RecommendedArticleDetails;
