...
const PageBetween1And2 = ({ data }) => {
  ...
  return (
    <div
      className="grid grid-cols-2 items-center  gap-[7.56520rem]   w-4/5 text-center mx-auto mb-24"
      ...
      >
        ...
        {language === "en" ? (
          ...
          >
            ...
            <span className="text-[#e9c237]"> جرامًا أو جزءًا،</span> اعرف بالضبط قيمة استثمارك.
          </p>
        )}
      </div>
    </div>
...
export default PageBetween1And2;
